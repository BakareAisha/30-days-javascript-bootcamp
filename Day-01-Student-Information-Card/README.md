...
The Student Information Card displays a student's personal information when the user clicks the "Show Information" button and hides the information when the "Hide Information" button is clicked.
