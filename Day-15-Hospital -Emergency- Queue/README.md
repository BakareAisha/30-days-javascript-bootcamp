...
- Demonstrates how `shift()` removes the first patient (commented for learning purposes)
...
> **Note:** During development, the `shift()` method was commented out to clearly demonstrate the effect of `unshift()`. Uncommenting `shift()` removes the first patient from the queue.
